require.config({
    paths: {
        ...
        'mugen-scroll' : 'https://unpkg.com/vue-mugen-scroll@0.2.5/dist/vue-mugen-scroll.min'
    ...
    const vm = new Vue({
        ...
        created() {
            this.loadData().then(response => {
                ...
                this.locale = "en-ca";
                this.property.default_logo_url = "//codecloud.cdn.speedyrails.net/sites/5afb8d456e6f6436aa100000/image/png/1520457094000/blacklogo2.png";
