require.config({
    paths: {
        ...
        'lightbox': '//codecloud.cdn.speedyrails.net/sites/59347e776e6f64538f150000/application/javascript/1525443097000/lightbox',
    ...
    const vm = new Vue({
        ...
        created() {
            this.loadData().then(response => {
                ...
                this.locale = "en-ca";
                this.property.default_logo_url = "//codecloud.cdn.speedyrails.net/sites/5aec62a16e6f64422c090000/image/png/1520457094000/blacklogo2.png";
