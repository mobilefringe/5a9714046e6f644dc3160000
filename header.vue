    			...
    			<div class="row top_bar_wrapper">
    				<div class="col-sm-4">
    					...
    					<div id="home_hours_container" class="hidden_phone" v-if="todays_hours">
    					    <router-link class="header_hours_link" to="/hours">
    				...
    				<div class="col-sm-8 hidden_phone text-right">
    				    <router-link id="covid_btn" to="/covid19-news"><span>{{$t("header.covid_updates")}}</span></router-link>
    								...
    								<li v-for="(item,key) in menu_items" class="menu_item">
    							        ...
    							        <div v-else>
    							            <b-card no-body class="mb-1">
                                                ...
                                                <b-collapse id="item.id" v-model="item.show_sub_menu" :id="item.id" :visible="item.show_sub_menu" :accordion="$t(item.name)" role="tabpanel" class="accordion_body">
    						    ...
    						    <li v-for="(item, index) in menu_items" class="menu_item" :class="{dropdown : item.sub_menu,open : item.open_dropdown}" >
    						        ...
    						        <ul v-if="item.sub_menu" class="dropdown-menu" :class="{ show: item.open_dropdown }">
    						            <li v-for="sub_menu in item.sub_menu" class="dropdown_item">
    						                <a v-if="sub_menu.external" :href="sub_menu.href">{{$t(sub_menu.name)}}</a>
