			...
			<div class="row">
				...
				<div class="col-sm-8 promo_image_container text-left">
					...
					<div class="row">
						...
						<social-sharing :url="shareURL(currentJob.slug)" :title="currentJob.name" :description="currentJob.description" :quote="_.truncate(currentJob.description, {'length': 99})" twitter-user="BCCstyle" :media="currentJob.image_url" inline-template >
