                ...
                <div class="col-md-8">
                    <div class="post_details_container right_border">
                        ...
                        <router-link to="/one_planet">
                            <button class="contact_btn">Back to One Planet</button>
                        </router-link>
                    </div>
                </div>
                <div class="col-md-4">
...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment", "vue-social-sharing"], function (Vue, Vuex, moment, tz, VueMoment, SocialSharing) {
        return Vue.component("one-planet-details-component", {
            ...
            computed: {
                ...
                relatedPosts () {
                    var blog_posts = _.reverse(_.orderBy(this.findBlogByName("One Planet").posts, function (o) { return o.publish_date }));
