			...
			<div class="row">
				...
				<div class="col-sm-8 promo_image_container text-left">
					...
					<div class="row">
						...
						<social-sharing :url="shareURL(currentPromo.slug)" :title="currentPromo.name" :description="currentPromo.description" :quote="_.truncate(currentPromo.description, {'length': 99})" twitter-user="BCCstyle" :media="currentPromo.image_url" inline-template >
