	...
	<div class="page_container" id="contact_us_container">
		...
		<div class="site_container">
			<div class="row margin_40">
				<div class="col-md-6">
				    <iframe width="100%" height="500px" src="https://www.youtube.com/watch?v=2xy9xXwwhFA&feature=youtu.be" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>	
				</div>
				<div class="col-md-6">
