			...
			<div class="row">
				...
				<div class="col-sm-8 promo_image_container text-left">
					<div class="col-sm-12 no_padding">
						<png-map ref="pngmapref" v-bind:png-map-url="getPNGurl" :height="_.toNumber('625')" @updateMap="updatePNGMap"></png-map>
					</div>
				</div>
			</div>
			<hr class="green_hr">
        ...
        return Vue.component("store-details-component", {
            ...
            methods: {
                ...
                updatePNGMap(map) {
                    ...
                    this.pngMapRef.focusTo(this.currentStore.x_coordinate, this.currentStore.y_coordinate, 100);
                },
            }
        });
    });
